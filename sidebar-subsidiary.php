<?php evo_abovesubasides() ?>
    ...
    <div id="subsidiary">
        ...
        <?php evo_between_firstsecond_sub() ?>       
        ...
        <?php evo_between_secondthird_sub() ?>
        ...
        <?php evo_after_third_sub() ?> 
        
    </div><!-- #subsidiary -->
    <?php } ?>


<?php evo_belowsubasides() ?>
