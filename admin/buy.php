	<?php $upthemes =  get_bloginfo('template_directory').'/admin/';?>
    ...
    <div id="upthemes_framework">
        ...
        <div id="up_header" class="polish">
            ...
            <h1 id="up_logo"><a href="<?php bloginfo('url');?>/wp-admin/admin.php?page=upthemes">UpThemes Framework</a></h1>
            
            <ul id="up_topnav">
                <li class="support"><a href="http://upthemes.com/forum/">Support</a></li>
                <li class="documentation"><a href="<?php bloginfo('url');?>/wp-admin/admin.php?page=upthemes-docs">Theme Documentation</a></li>
                <li class="buy-themes current"><a href="<?php bloginfo('url');?>/wp-admin/admin.php?page=upthemes-buy">Buy Themes</a></li>
            </ul><!-- /#up_topnav -->
