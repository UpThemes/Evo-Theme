...
function evo_body_class( $print = true ) {
  ...
  // Adds classes for the month, day, and hour when the post was published
		if ( isset( $wp_query->post->post_date ) )
			evo_date_classes( mysql2date( 'U', $wp_query->post->post_date ), $c, 's-' );
...
function evo_post_class( $print = true ) {
	global $post, $evo_post_alt;

	// hentry for hAtom compliace, gets 'alt' for every other post DIV, describes the post type and p[n]
	$c = array( 'hentry', "p$evo_post_alt", $post->post_type, $post->post_status );
	...
	evo_date_classes( mysql2date( 'U', $post->post_date ), $c );
...
function evo_comment_class( $print = true ) {
	global $comment, $post, $evo_comment_alt, $comment_depth, $comment_thread_alt;
	...
	evo_date_classes( mysql2date( 'U', $comment->comment_date ), $c, 'c-' );
	if ( ++$evo_comment_alt % 2 )
		$c[] = 'alt';
...
function evo_date_classes( $t, &$c, $p = '' ) {
