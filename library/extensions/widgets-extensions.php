...
function evo_search_form() {
				...
				$search_submit = '<input id="searchsubmit" name="searchsubmit" type="submit" value="' . __('Go', 'evo') . '" tabindex="2" />';

				$search_form .= apply_filters('evo_search_submit', $search_submit);
				...
				echo apply_filters('evo_search_form', $search_form);
